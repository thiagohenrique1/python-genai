...
ToolListUnion = typing.List[ToolUnion]
ToolListUnionDict = typing.List[ToolUnionDict]

DictAny = typing.Dict[Any, Any]
if GenericAliasType is not None:
  SchemaUnion = Union[
      DictAny, type, Schema, GenericAliasType, VersionedUnionType  # type: ignore[valid-type]
  ]
else:
  SchemaUnion = Union[
      DictAny, type, Schema, VersionedUnionType  # type: ignore[valid-type]
  ]
...
ContentUnion = Union[Content, PartUnion, typing.List[PartUnion]]


ContentUnionDict = Union[
    Content, ContentDict, PartUnionDict, typing.List[PartUnionDict]
]
...
ContentListUnion = Union[ContentUnion, typing.List[ContentUnion]]


ContentListUnionDict = Union[ContentUnionDict, typing.List[ContentUnionDict]]
  ...
  def _from_response(
    ...
    if (
        ...
        and not (
            ...
            and isinstance(response_schema, GenericAliasType)
      ...
      try:
        ...
        (GenericAliasType is not None and isinstance(response_schema, GenericAliasType))
...
BatchJobSourceUnion = Union[
    BatchJobSource, typing.List[InlinedRequest], str
]


BatchJobSourceUnionDict = Union[
    BatchJobSourceUnion, BatchJobSourceDict, typing.List[InlinedRequestDict]
]
